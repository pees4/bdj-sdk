...
public class Poops {
	...
	private static List successfulSockets = new ArrayList();
...
private static int findTriplet(int master, int other, int timeout) {
    ...
    private static boolean triggerUcredTripleFree() {
        try {
            ...
            console.println("Exception in triggerUcredTripleFree");
            return false;
        }
    }
